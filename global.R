...
population2 <- c(log(204200000,base=10),log(68900000,base=10),log(34800000,base=10),log(19000000,base=10),log(114200000,base=10),log(64100000,base=10),log(1339200000,base=10))


names(population) <- states
names(population2) <- states
